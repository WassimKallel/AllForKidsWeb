                                                                ...
                                                                <div class="product-details">
                                                                    <div class="product-media">  
                                                                        <span class="hover-image white-bg">   
                                                                            <img alt="" src="assets/img/product/cat-7.png">  
                                                                        </span>                                              
                                                                        ...
                                                                        <div class="product-overlay">
                                                                            ...
                                                                            <a href="#product-preview" data-toggle="modal" class="compare pink-background fa fa-eye"></a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="product-content">
                                                                        <div class="rating">                                                              
                                            ...
                                            <div class="block-bg  light-bg">
                                                <div class="col-md-3 col-sm-6  menu-block">
                                                    <div class="sub-list">
                                                        ...
                                                        <ul>
                                                            <li> <i class="fa fa-angle-right pink-color"></i> <a href="categories-listing.html">Category Listing</a> </li>
                                                            <li> <i class="fa fa-angle-right pink-color"></i> <a href="product-grid-fullwidth.html">Category Grid View Full Width</a> </li>
